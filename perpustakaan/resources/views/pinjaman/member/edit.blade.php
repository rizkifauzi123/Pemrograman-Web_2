...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <!-- form validasi -->
            <form class="forms-sample" action="{{ url('/tampilan/member/update', $member->id) }}" method="POST">
                @csrf
                @method('put')
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Nama Lengkap" values="{{ $member->name }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="email" name="email"
                            placeholder="Email" values="{{ $member->email }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="status" name="status"
                            placeholder="Status" values="{{ $member->status }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="address" name="address"
                            placeholder="Alamat" values="{{ $member->address }}">
                    </div>
                </div>
